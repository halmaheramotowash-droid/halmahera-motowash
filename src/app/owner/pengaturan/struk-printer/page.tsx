...
export default function StrukPrinterPage() {
  ...
  const [receiptSaving, setReceiptSaving] =
    useState(false);
  ...
  const [bluetoothError, setBluetoothError] =
    useState("");
  ...
  const [gattLoading, setGattLoading] =
    useState(false);

  const [gattError, setGattError] =
    useState("");

  const [showGattDetails, setShowGattDetails] =
    useState(false);
  ...
  async function inspectGatt(
    ...
    try {
      ...
      let detectedServiceUuid: string | null =
        null;

      let detectedCharacteristicUuid: string | null =
        null;

      let detectedWriteMode: string | null =
        null;
  ...
  function bluetoothStatusClass() {
    switch (bluetoothStatus) {
      ...
      case "FAILED":
        return "border-red-900 bg-red-950/30 text-red-500";
  ...
  async function loadReceiptSettings() {
    try {
      ...
      const setting =
        data.setting as ReceiptSetting;
        ...
        <section className="mb-4 rounded-2xl border border-zinc-800 bg-zinc-950 p-4">
          <div className="mb-4">
            ...
            <p className="mt-1 text-xs text-zinc-500">
              Persiapkan koneksi dan inspeksi
              perangkat Bluetooth
            </p>
          </div>
          ...
          <div className="rounded-xl border border-zinc-800 bg-black p-4">
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p
                  className={`mt-2 inline-flex rounded-lg border px-3 py-1.5 text-[10px] font-black ${bluetoothStatusClass()}`}
                >
            ...
            {!bluetoothSupported &&
              bluetoothStatus ===
                "UNSUPPORTED" && (
                <div className="mt-4 rounded-xl border border-yellow-900 bg-yellow-950/30 p-3">
                  <p className="text-xs font-bold leading-relaxed text-yellow-500">
                    Browser ini belum
                    menyediakan Web Bluetooth.
            ...
            <div className="mt-4 flex gap-2">
              ...
              "CONNECTED" ? (
                <button
                  ...
                  className="w-full rounded-xl border border-red-900 bg-red-950/30 px-4 py-3 text-xs font-black text-red-500 transition hover:bg-red-950"
                >
                  PUTUSKAN
                </button>
              ) : (
                <button
                  ...
                  className="w-full rounded-xl bg-red-600 px-4 py-3 text-xs font-black text-white transition hover:bg-red-500 disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {bluetoothStatus ===
                  "SEARCHING"
                    ? "MENCARI..."
            ...
            {bluetoothDevice &&
              bluetoothStatus ===
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-xl border border-zinc-700 bg-zinc-900 px-4 py-3 text-xs font-black text-zinc-300 transition hover:border-red-600 hover:text-white"
                >
                  {showGattDetails
                    ? "SEMBUNYIKAN GATT"
                    : "LIHAT DETAIL GATT"}
            ...
            {bluetoothDevice &&
              ...
              bluetoothCharacteristicUuid && (
                <div className="mt-4 rounded-xl border border-green-900 bg-green-950/30 p-3">
            ...
            {showGattDetails && (
              <div className="mt-4 rounded-xl border border-zinc-800 bg-zinc-950 p-3">
                ...
                {gattLoading ? (
                  <div className="rounded-lg border border-zinc-800 bg-black p-4 text-center">
                                  ...
                                  >
                                    ...
                                    <div className="mt-2 flex flex-wrap gap-1">
                                      {characteristic
                                        ...
                                        .length ===
                                      0 ? (
                                        <span className="rounded-md border border-zinc-800 px-2 py-1 text-[8px] font-black text-zinc-600">
                                          NO PROPERTY
                                        </span>
                                      ) : (
            ...
            <p className="mt-4 text-[10px] leading-relaxed text-zinc-600">
              Tahap ini hanya membaca struktur
              GATT. Aplikasi belum mengirim data
              cetak apa pun ke perangkat.
            </p>
          </div>
        </section>
            ...
            >
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-3 text-sm font-bold text-white outline-none focus:border-red-600"
                >
                  <option value="58">
                    58 mm
                  </option>
              ...
              <label className="flex cursor-pointer items-center justify-between rounded-xl border border-zinc-800 bg-black p-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-zinc-500">
                    Nomor telepon usaha ditampilkan
                    pada struk.
                  </p>
                </div>
              ...
              <button
                ...
                className="w-full rounded-xl bg-red-600 px-4 py-3 text-sm font-black text-white transition hover:bg-red-500 disabled:cursor-not-allowed disabled:opacity-50"
              >
                {receiptSaving
                  ? "MENYIMPAN..."
        ...
        <section className="rounded-2xl border border-zinc-800 bg-zinc-950 p-4">
          ...
          {showAddForm && (
            <form
              ...
              className="mb-4 rounded-xl border border-red-900 bg-black p-4"
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  className="rounded-lg border border-zinc-800 px-2 py-1 text-[10px] font-black text-zinc-500 transition hover:text-white"
                >
                  BATAL
                </button>
              </div>
              ...
              <div className="mt-4 space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setConnectionType(
                        e.target
                          .value as Printer["connectionType"]
                      )
                    }
                    className="w-full rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-3 text-sm font-bold text-white outline-none focus:border-red-600"
                  >
                ...
                <label className="flex cursor-pointer items-center gap-3 rounded-xl border border-zinc-800 bg-zinc-900 p-3">
                  <input
                    type="checkbox"
                    checked={
                      isDefault
          ...
          {loading ? (
            ...
            <div className="rounded-xl border border-zinc-800 bg-black p-5 text-center">
              ...
              <p className="mt-1 text-xs text-zinc-600">
                Tambahkan printer untuk
                menggunakan fitur cetak struk.
              </p>
            </div>
          ) : (
            <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        {printer.connectionType ===
                          ...
                          printer.bluetoothCharacteristicUuid && (
                            <p className="mt-2 text-[9px] font-bold text-green-500">
                              Bluetooth siap
                              untuk konfigurasi
                              print
                            </p>
                      ...
                      <div className="flex shrink-0 items-center gap-2">
                        {printer.isDefault && (
                          <span className="rounded-lg border border-green-900 bg-green-950/30 px-2 py-1 text-[9px] font-black text-green-500">
                            DEFAULT
                          </span>
                        )}
                        ...
                        <button
                          ...
                          className="rounded-lg border border-zinc-700 px-3 py-2 text-[10px] font-black text-zinc-300 transition hover:border-red-600 hover:text-white"
                        >
                          EDIT
                        </button>
                        ...
                        <button
                          ...
                          onClick={() =>
                            handleDeactivatePrinter(
                              printer
                            )
                          }
                          className="rounded-lg border border-red-900 px-3 py-2 text-[10px] font-black text-red-500 transition hover:bg-red-950 hover:text-red-400 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                          {deletingId ===
                          printer.id
                            ? "MEMPROSES..."
